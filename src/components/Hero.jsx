    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-brand-600/20 border border-brand-500/30 rounded-full px-4 py-1.5 text-sm text-brand-300 font-medium mb-6">
            <MapPin size={13} />
          ...
          <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
            From 12-seater travellers to 50-seater luxury buses for city tours, school trips, weddings, corporate events & outstation travel. Fuel included. Professional drivers. Any destination.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a href={`tel:+919396484899`}
              className="flex items-center justify-center gap-3 px-8 py-4 bg-brand-600 hover:bg-brand-500 rounded-xl text-white font-semibold text-lg transition-all duration-200 hover:shadow-lg hover:shadow-brand-600/30 hover:-translate-y-0.5">
              <Phone size={20} />
              Call to Book — 93964 84899
            </a>
            <a href={WA_URL} target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-500 rounded-xl text-white font-semibold text-lg transition-all duration-200 hover:shadow-lg hover:shadow-green-600/30 hover:-translate-y-0.5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {stats.map((s, i) => (
              <div key={i} className="bg-dark-700/60 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-3 text-center">
